...
| 4 | [phase-4-mobile.md](./phase-4-mobile.md) | ⚪ Not started | React Native/Expo app |
| 5 | [phase-5-stripe-billing.md](./phase-5-stripe-billing.md) | ⚪ Not started | Full Stripe checkout, webhooks, tier enforcement |
| 6 | [phase-6-ai-lesson-generation.md](./phase-6-ai-lesson-generation.md) | ⚪ Not started | Ollama/Mistral lesson generation, template engine |
| 7 | [phase-7-ai-personalization.md](./phase-7-ai-personalization.md) | ⚪ Not started | Recommendation engine, adaptive difficulty, AI coaching |
| 8 | [phase-8-notifications-habit.md](./phase-8-notifications-habit.md) | ⚪ Not started | Push notifications, streak engine, UX polish |
| 9 | [phase-9-admin-cms.md](./phase-9-admin-cms.md) | ⚪ Not started | Admin auth, lesson authoring, skill path management |
| 10 | [phase-10-enterprise-team.md](./phase-10-enterprise-team.md) | ⚪ Not started | Team accounts, team analytics, enterprise custom paths |

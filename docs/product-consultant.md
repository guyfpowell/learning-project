...
| 6 | Stakeholder Management | ✅ All 4 levels in `lesson_config.py` (2026-06-13) | ✅ All 4 levels (320 lessons) |
| 7 | Go-to-Market & Launch | ✅ All 4 levels in `lesson_config.py` (2026-06-13) | ⚪ No |
...
- ~~**L&I ↔ SM master carve (2026-06-12):**~~ ✅ Applied 2026-06-13 when Track 6 was sequenced. SM owns the stakeholder *system* (mapping, engagement plans, cadences, review meetings, coalitions, boards/investors/CEO); L&I owns the *personal craft* (persuasion, negotiation, trust, feedback, people leadership, culture, org building). L&I cut "Stakeholder mapping and prioritisation" (replaced with negotiation) and reframed "Running effective product reviews" to decision facilitation. Both Track 6 flags resolved: SM intermediate "Navigating political environments" took the stakeholder-alignment lens; SM advanced "The executive sponsor relationship" took the governance/engagement-machinery lens.
...
- ~~**L&I expert "Making the company product-led" (2026-06-12):**~~ ✅ Applied 2026-06-13 when Track 7 was sequenced. GTM intermediate topic 2 ("Choosing your go-to-market motion") owns the PLG motion mechanics; GTM expert capstone ("Building a launch-capable organisation") `through_line` cedes the company-wide product-led culture change to L&I.
- **M&A is now four-way carved (2026-06-12):** Product Strategy expert owns the acquisition thesis, L&I expert owns the product leader's operational role (diligence, integration, the acquired team), Technical Skills owns technical due diligence, and SM's "Stakeholder management across an acquisition" takes the stakeholder-comms lens (✅ SM part applied 2026-06-13 — the stakeholder map an M&A explodes: two boards, two teams, customers, regulators, the market).
...
- ~~**Track 6 (Stakeholder Management) intermediate** "Using data to win alignment"~~ — ✅ Resolved 2026-06-13: took the persuasion/alignment lens (data as the neutral arbiter that aligns stakeholders); metric craft, dashboards, and statistical rigour stay with Track 4.
...
- ~~**E&D ↔ Track 6 (Stakeholder Management) carve (2026-06-12):**~~ ✅ Resolved 2026-06-13: E&D owns operational incident response; SM advanced "Stakeholder management during a crisis or public incident" took the stakeholder-comms lens only (and SM expert added the company-scale, board/investor version "…when the company is publicly in trouble").
...
- ~~**SM ↔ Track 7 (Go-to-Market) carves (2026-06-13):**~~ ✅ Applied 2026-06-13 when Track 7 was sequenced. SM owns the *ongoing relationships*; GTM owns *launch execution*. GTM beginner topic 5 and intermediate topic 9 own marketing *launch collaboration* (their `through_line`s defer the ongoing relationship to SM); GTM advanced topic 7 ("Analyst and influencer relations for PMs") owns analyst-influence *for launches* on the launch-and-influence lens (defers analysts-as-relationships to SM). Also honoured the PS↔GTM carves: GTM intermediate topic 4 owns launch pricing/packaging (PS owns strategic pricing); GTM advanced topics 4–5 own international launch execution/localisation (PS owns market selection/sequencing); GTM expert topic 3 owns category-creation *demand generation* (PS owns the category-creation strategy).
- **SM ↔ Track 8 (Product Communication) carves (2026-06-13):** SM owns the stakeholder *system and relationships*; PC owns the *writing/presentation craft*. SM beginner "Writing a product update people actually read" owns the stakeholder update but defers Minto/writing craft to PC (and SM cut a standalone "documentation" topic, ceding it to PC). SM advanced/expert crisis and external-stakeholder topics defer crisis-comms and external-audience *craft* to PC. When sequencing Track 8, take the craft lens and let SM keep the relationship/system lens.
...
| 2026-06-13 | 6 — Stakeholder Management | All 4 levels sequenced (full proposal reviewed before writing) and written to `lesson_config.py` (levels at 2995/3160/3325/3490, approx); rationale notes in `lesson-build.md`. **Track 6 complete — 40 topics, 320 lessons, not yet generated.** Track spine: identify relationships (beginner) → run a stakeholder *system* (intermediate) → manage up/across under pressure (advanced) → the governance layer and the institution itself (expert). Applied the L&I↔SM master carve (SM owns the system + governance relationships; L&I owns the personal craft). All four ⚠️ Track 6 flags resolved: "Navigating political environments" → stakeholder-alignment lens; "The executive sponsor relationship" → governance/machinery lens; "Using data to win alignment" → persuasion lens; crisis → stakeholder-comms lens. Key moves: beginner added "What stakeholders want from you", cut standalone "Documentation" (→ PC); advanced reframed "When stakeholders are wrong" → "Standing your ground…" and the external topic → executive-altitude, made crisis the level capstone; expert reframed exec-alignment to the alignment-machinery lens, M&A to stakeholder-comms lens, cut "global exec team" for a new "stakeholder operating system" topic, escalated crisis to company scale, and made "When the organisation itself is your hardest stakeholder" the whole-track capstone. New forward carves for Tracks 7 (GTM) and 8 (PC) added to the watch-list. Generate with: `python3 scripts/generate-lessons.py --batch --tracks "Stakeholder Management"`. Next session: Track 7 — Go-to-Market & Launch. |
| 2026-06-13 | 7 — Go-to-Market & Launch | All 4 levels sequenced (full proposal reviewed before writing) and written to `lesson_config.py` (replaced the flat intermediate/advanced entry; beginner & expert are new); rationale notes in `lesson-build.md`. **Track 7 complete — 40 topics, 320 lessons, not yet generated.** Track spine: run a launch (beginner) → design a GTM strategy (intermediate) → lead complex multi-market launches (advanced) → own GTM capability at org level (expert). Whole-track capstone = expert "Building a launch-capable organisation". Key moves: intermediate de-duplicated against beginner (cut/elevated launch tiers→positioning, launch brief→cross-functional plan, retro→post-launch adoption); advanced reordered "Managing launch risk" 5→1 as frame-setter and split international into localisation + multi-market coordination; expert cut "Platform launches" (dup of advanced/PS) for a new "GTM operating model" topic and made "Building a launch-capable organisation" the whole-track capstone. **All GTM-side watch-list carves honoured, not deferred:** PLG motion mechanics (vs L&I culture change), launch pricing/packaging (vs PS strategic pricing), international launch execution (vs PS market selection), analyst-influence for launches (vs SM relationships), marketing launch collaboration (vs SM relationship), category-creation GTM/demand (vs PS category strategy), launch comms/incident (vs E&D), no AI-launch topics (AI track). No new cross-track flags raised. Generate with: `python3 scripts/generate-lessons.py --batch --tracks "Go-to-Market & Launch"`. Next session: Track 8 — Product Communication. |
